<?php
// if(get_option('wpsc_selected_theme') == 'quickSpikes') {
...
// 		$wpsc_theme['html'] ="<input type='image' src='".WPSC_URL."/themes/quickSpikes/images/atc.gif' id='product_".$product['id']."_submit_button' class='wpsc_buy_button' name='Buy' value='".__('Add To Cart', 'wpsc')."'  />";
// 		return $wpsc_theme;
// 	}
// }
?>